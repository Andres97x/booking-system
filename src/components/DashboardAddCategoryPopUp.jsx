...
const DashboardAddCategoryPopUp = ({ closePopUp }) => {
  ...
  // useEffect(() => {
  //   const categoriesFolderRef = ref(storage, `categories/`);

  //   listAll(categoriesFolderRef).then(response => {
...
export default DashboardAddCategoryPopUp;
